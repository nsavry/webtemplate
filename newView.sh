...
then
	...
	echo -e "the following lines were added in your index.html, make sure that they were present"
	...
	echo -e "\nthe following lines were added in your js/module.js, make sure that they were present"
	echo -e "\t'$1',"

	echo -e "\nthe following lines were added in your js/config.js, make sure that they were present"
	echo -e "\t.state('$1', {"
	echo -e "\t\turl: '/$1',"
